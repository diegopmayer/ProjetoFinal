...
urlpatterns = [
    ...
    url(r'^veiculos-update/(?P<id>\d+)/$', veiculos_update, name='core_veiculos_update'),
    ...
    path('mov-mensalista-update/<int:id>/', mov_mensalista_update, name='mov_mensalista_update'),
